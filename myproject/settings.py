...
SECRET_KEY = 'django-insecure-#jdm(819^$d3zj(u24jp$#cs^2nnrl(y9my^z%5iwaz0#69v(!'
...
DATABASES = {   
	'default': {
		...
		'NAME': os.environ.get('POSTGRES_DB', 'mydb'),          # Имя базы данных (по умолчанию для PostgreSQL)
